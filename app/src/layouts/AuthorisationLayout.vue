...
<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-200 to-blue-400 flex items-center justify-center px-4 sm:px-6 lg:px-8">
    ...
    <div class="relative w-full max-w-md">
      <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8">
